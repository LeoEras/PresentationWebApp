"""
Django settings for presApp project.
...
SECRET_KEY = 'django-insecure-zo99&8rg#szymv5v4*16sva%!#vx8xe-!2^-ip%)ab&cuf3k-q'
...
WSGI_APPLICATION = 'presApp.wsgi.application'
